...
import { LayoutDashboard, Eye, EyeOff, Mail, Lock, ArrowRight } from "lucide-react";
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <div className="mt-8 grid grid-cols-3 gap-3">
            {[
              ...
              { label: "Lições", value: "120+" },
              { label: "Ativos", value: "500+" },
            ].map((stat) => (
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-4 py-2.5 rounded-lg bg-card border border-border/50 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50"
                  />
                </div>
              </div>
            )}
