...
const trails: Trail[] = [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        content: "Bull Market é um período prolongado de alta nos preços das ações — o otimismo domina, as pessoas compram com confiança e os valuations se expandem.\n\nBear Market é o oposto: quedas sustentadas (geralmente >20% do topo), pessimismo generalizado e aversão ao risco.\n\nAmbos são naturais, cíclicos e inevitáveis. Investidores inteligentes compram durante Bear Markets (quando os preços estão deprimidos e as oportunidades abundam) e mantêm a disciplina durante Bull Markets (resistindo à euforia de pagar caro por qualquer coisa).\n\nComo disse Warren Buffett: \"Tenha medo quando os outros são gananciosos e seja ganancioso quando os outros têm medo.\"",
  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        content: "Albert Einstein supostamente chamou os juros compostos de \"a oitava maravilha do mundo\".\n\nR$10.000 investidos com retorno de 15% ao ano:\n• Em 10 anos: R$40.456\n• Em 20 anos: R$163.665\n• Em 30 anos: R$662.118\n\nO efeito \"bola de neve\" se acelera com o tempo — os primeiros anos parecem lentos, mas a partir do 15º-20º ano o crescimento se torna exponencial.\n\nReinvestir dividendos potencializa ainda mais o efeito: dividendos compram mais ações, que geram mais dividendos, que compram mais ações...\n\nTempo no mercado > timing de mercado. Começar cedo é mais importante que começar com muito.",
