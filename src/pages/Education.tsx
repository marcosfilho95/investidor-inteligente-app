...
const trails: Trail[] = [
  {
    ...
    modules: [
      ...
      {
        title: "Reserva de emergência — a base da sua estratégia",
        content: "Reserva de emergência é o capital que protege sua vida financeira de imprevistos: perda de renda, problemas de saúde, manutenção inesperada da casa/carro, urgências familiares ou qualquer evento que exija dinheiro rápido.\n\nSem reserva, o investidor tende a vender bons ativos na pior hora, se endividar caro (cartão/cheque especial) ou interromper completamente o plano de longo prazo.\n\nPor que ela é tão importante:\n• protege seu patrimônio em momentos de estresse\n• evita decisões emocionais com a carteira\n• mantém continuidade dos aportes no longo prazo\n• reduz risco de entrar em dívida cara\n\nTamanho recomendado (regra prática):\n• 6 meses de custo de vida para renda estável (CLT/baixa variabilidade)\n• 9 a 12 meses para renda variável (autônomo/empreendedor/comissionado)\n• no início, mire primeiro em 1 mês de despesas; depois avance para 3, 6 e 12\n\nComo calcular:\n1. some despesas essenciais mensais (moradia, alimentação, saúde, transporte, contas)\n2. multiplique pelo número de meses-alvo\n3. inclua uma margem de segurança para inflação e gastos sazonais\n\nOnde alocar a reserva (prioridade: liquidez e segurança, não retorno máximo):\n• Tesouro Selic\n• CDB com liquidez diária e cobertura FGC\n• fundos DI de baixíssimo custo (quando fizer sentido)\n\nPrincípios-chave:\n• reserva não é para buscar alta rentabilidade\n• evite produtos com carência, alta volatilidade ou risco de crédito elevado\n• se precisar usar, reponha com prioridade no orçamento\n\nErros comuns:\n• investir a reserva em ações, cripto ou ativos muito voláteis\n• confundir limite de cartão com reserva\n• deixar toda a reserva parada sem planejamento de recomposição após uso\n\nEstratégia prática de implementação:\n1. automatize um aporte mensal dedicado à reserva\n2. separe em conta/investimento exclusivo para não misturar com gastos do dia a dia\n3. ao bater a meta, redirecione os novos aportes para a carteira de longo prazo\n\nA reserva de emergência não acelera sua riqueza diretamente, mas impede retrocessos graves. Ela é o componente que sustenta disciplina, consistência e sobrevivência financeira em ciclos ruins.",
        tip: "Primeiro construa a reserva, depois acelere risco. Sem liquidez de emergência, qualquer imprevisto pode desmontar uma estratégia ótima no papel."
      },
      {
