  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        content: "O day trade consiste em comprar e vender ativos no mesmo dia tentando lucrar com pequenas variações de preço.\n\nApesar de parecer atraente, estudos acadêmicos e dados regulatórios mostram que a maioria dos participantes não obtém sucesso consistente nessa atividade.\n\nPesquisas baseadas em dados da B3 indicam que cerca de 97% dos traders pessoas físicas perdem dinheiro ao longo do tempo.\n\nAlguns fatores explicam esse resultado:\n• competição direta com algoritmos e traders profissionais\n• custos operacionais (corretagem, spread e impostos)\n• necessidade de tomada de decisão extremamente rápida\n• pressão psicológica constante\n• tendência a aumentar risco após perdas\n\nAlém disso, o trading frequente pode gerar estresse significativo. A exposição contínua a ganhos e perdas rápidas pode levar a impulsividade, ansiedade, insônia, conflitos familiares e desgaste emocional relevante.\n\nEm casos extremos, esse ciclo de perdas e pressão psicológica pode evoluir para quadros graves de sofrimento mental, incluindo depressão e risco de suicídio. Esse tema é sério e precisa ser tratado com responsabilidade.\n\nPor isso, muitos educadores financeiros recomendam que investidores iniciantes priorizem estratégias de longo prazo, focadas em qualidade de empresas e disciplina de aportes.\n\nJá dizia o oráculo de Omaha: \"Eu nunca vi ninguém ficar rico usando gráficos.\"\n\nNo longo prazo, patrimônio tende a ser construído com método, fundamentos e disciplina, não com previsões de curto prazo.",
